...
#[derive(Debug, Clone, Copy)]
pub struct Stats {
    battery_terminal_voltage: f16,
    array_voltage: f16,
    load_voltage: f16,
    charge_current: f16,
    load_current: f16,
    battery_current_net: f16,
    battery_sense_voltage: f16,
    meterbus_voltage: f16,
    heatsink_temperature: f16,
    battery_temperature: f16,
    ambient_temperature: f16,
    rts_temperature: f16,
    u_inductor_temperature: f16,
    v_inductor_temperature: f16,
    w_inductor_temperature: f16,
    charge_state: ChargeState,
    array_faults: ArrayFaults,
    battery_voltage_slow: f16,
    target_voltage: f16,
    ah_charge_resettable: f32,
    ah_charge_total: f32,
    kwh_charge_resettable: f16,
    kwh_charge_total: f16,
    ...
    array_power: f16,
    array_vmp: f16,
    array_max_power_sweep: f16,
    array_voc: f16,
    battery_v_min_daily: f16,
    battery_v_max_daily: f16,
    ah_charge_daily: f16,
    ah_load_daily: f16,
    array_faults_daily: ArrayFaults,
    load_faults_daily: LoadFaults,
    alarms_daily: Alarms,
    array_voltage_max_daily: f16,
    array_voltage_fixed: f16,
    array_voc_percent_fixed: f16
}
...
impl Con {
    ...
    pub fn stats(&self) -> Result<Stats, Error> {
        ...
        fn gf32(hi: u16, low: u16) -> f32 { f32::from_bits((high as u32) << 16 | (low as u32)) }
        Ok(Stats {
            battery_terminal_voltage: f16::from_bits(raw[0x0012]),
            array_voltage: f16::from_bits(raw[0x0013]),
            load_voltage: f16::from_bits(raw[0x0014]),
            charge_current: f16::from_bits(raw[0x0010]),
            load_current: f16::from_bits(raw[0x0016]),
            battery_current_net: f16::from_bits(raw[0x0015]),
            battery_sense_voltage: f16::from_bits(raw[0x0017]),
            meterbus_voltage: f16::from_bits(raw[0x0008]),
            heatsink_temperature: f16::from_bits([0x001A]),
            battery_temperature: f16::from_bits(raw[0x001B]),
            ambient_temperature: f16::from_bits(raw[0x001C]),
            rts_temperature: f16::from_bits(raw[0x001D]),
            u_inductor_temperature: f16::from_bits(raw[0x001E]),
            v_inductor_temperature: f16::from_bits(raw[0x001F]),
            w_inductor_temperature: f16::from_bits(raw[0x0020]),
            charge_state: ChargeState::from(raw[0x0021]),
            array_faults: ArrayFaults::from_bits_truncate(raw[0x0022]),
            battery_voltage_slow: f16::from_bits(raw[0x0023]),
            target_voltage: f16::from_bits(raw[0x0024]),
            ah_charge_resettable: gf32(raw[0x0026], raw[0x0027]) * 0.1,
            ah_charge_total: gf32(raw[0x0028], raw[0x0029]) * 0.1,
            kwh_charge_resettable: f16::from_f32(f16::from_bits(raw[0x002A]).as_f32() * 0.1),
            kwh_charge_total: f16::from_f32(f16::from_bits(raw[0x002B]).as_f32() * 0.1),
            load_state: LoadState::from(raw[0x002E]),
            load_faults: LoadFaults::from_bits_truncate(raw[0x002F]),
            lvd_setpoint: f16::from_bits(raw[0x0030]),
            ah_load_resettable: gf32(raw[0x0032], raw[0x0033]) * 0.1,
            ah_load_total: gf32(raw[0x0034], raw[0x0035]) * 0.1,
            hourmeter: (raw[0x0036] as u32) << 16 | raw[0x0037] as u32,
            alarms: Alarms::from_bits_truncate((raw[0x0038] as u32) << 16 | raw[0x0039] as u32),
            array_power: f16::from_bits(raw[0x003C]),
            array_vmp: f16::from_bits(raw[0x003D]),
            array_max_power_sweep: f16::from_bits(raw[0x003E]),
            array_voc: f16::from_bits(raw[0x003F]),
            battery_v_min_daily: f16::from_bits(raw[0x0041]),
            battery_v_max_daily: f16::from_bits(raw[0x0042]),
            ah_charge_daily: f16::from_bits(raw[0x0043]),
            ah_load_daily: f16::from_bits(raw[0x0044]),
            ...
            array_voltage_max_daily: f16::from_bits(raw[0x004C]),
            array_voltage_fixed: f16::from_bits(raw[0x004F]),
            array_voc_percent_fixed: f16::from_bits(raw[0x0050])
        })
    }
}
